...
class QueryRequest(BaseModel):
    ...
    thread_id: Optional[str] = Field(
        default=None,
        description="Session thread ID for LangGraph checkpointing (UUID). Generated by frontend."
    )
...
class QueryResponse(BaseModel):
    ...
    run_id: Optional[str] = Field(None, description="LangSmith run ID for feedback annotation")
