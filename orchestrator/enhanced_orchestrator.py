"""
Enhanced Orchestration Logic for NL2SQL Multi-Agent System.
...
from config import MAX_RETRIES, VERBOSE
...
class EnhancedNL2SQLOrchestrator:
    """
...
def run_query(query: str, verbose: bool = True) -> FinalResponse:
    ...
    """
    orchestrator = EnhancedNL2SQLOrchestrator(verbose=verbose)
    return orchestrator.process_query(query)


# Keep backward compatibility
NL2SQLOrchestrator = EnhancedNL2SQLOrchestrator
