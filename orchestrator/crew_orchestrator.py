"""
Main orchestration logic for the NL2SQL Multi-Agent System.
...
class NL2SQLOrchestrator:
    """
    Main orchestrator for the NL2SQL Multi-Agent System.
...
def run_query(query: str, verbose: bool = True) -> FinalResponse:
    ...
    """
    orchestrator = NL2SQLOrchestrator(verbose=verbose)
